...
if __name__ == '__main__':
    path1 = "D://pythonProject1//test//orig_0.8_dis_10.txt"  #论文原文的文件的绝对路径（作业要求）
    path2 = "D://pythonProject1//test//orig_0.8_dis_15.txt"  #抄袭版论文的文件的绝对路径
    save_path = "D://pythonProject1//save.txt"   #输出结果绝对路径
